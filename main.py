...
origins = os.getenv(
    "CORS_ORIGINS",
    "https://falcontrade.org,https://www.falcontrade.org,https://falcontrade-frontend.vercel.app,https://falcontrade.vercel.app",
).split(",")
app.add_middleware(
    CORSMiddleware,
...
# Startup: init DB + seed admin if needed
...
def create_commodity(
    ...
    c = Commodity(
        name=data.name, unit=data.unit, price=data.price, source=data.source
    )
    db.add(c)
    db.commit()
    db.refresh(c)
